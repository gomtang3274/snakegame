...
bool snakegame::collision()
{
    ...
    if(gameMap[snake[0].x+Xmove][snake[0].y+Ymove]=='w'||gameMap[snake[0].x+Xmove][snake[0].y+Ymove]=='s')
    {
        errorchk = gameMap[snake[0].x+Xmove][snake[0].y+Ymove];
        return true;
    }
        
    
    if(gameMap[snake[0].x+Xmove][snake[0].y+Ymove]=='f'){
        itemWhat=1;
        chooseItem();
        points+=15;
        snakeLength++;
    ...
    else if(gameMap[snake[0].x+Xmove][snake[0].y+Ymove]=='p'){
        itemWhat=2;
        chooseItem();
        points+=10;
        snakeLength--;
